    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li><i class='bx bx-chevron-right' ></i></li>
                <li><a class="active" href="{{ route('customers.create') }}">Ajouter</a></li>
            </ul>
        </div>
    </div>
            ...
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div style="margin-bottom: 25px;">
                    ...
                    <textarea id="address" name="address" rows="3"
                              style="width: 100%; padding: 10px; border: 1px solid var(--grey); border-radius: 8px; box-sizing: border-box; font-size: 16px; color: var(--dark); background-color: var(--grey);">{{ old('address') }}</textarea>
                </div>
